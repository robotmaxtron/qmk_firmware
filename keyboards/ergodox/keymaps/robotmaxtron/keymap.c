 ...
 *
 * ,----------------------------------------------------.           ,----------------------------------------------------.
 * |   ~`     |   1  |   2  |   3  |   4  |   5  | LEFT |           | RIGHT|   6  |   7  |   8  |   9  |   0  |Bkspce/del|
 * |----------+------+------+------+------+-------------|           |------+------+------+------+------+------+----------|
 ...
 * |        |      |  Up  |      |      |      |      |           |      |      |   7  |   8  |   9  |   *  |   F11  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | Left | Down | Right|      |      |------|           |------|      |   4  |   5  |   6  |   +  |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |Mute  |VDown |Vup   |      |      |      |           |      |      |   1  |   2  |   3  |   \  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |   0  |   0  |   .  |   =  |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_P7,   KC_P8,    KC_P9,    KC_ASTR, KC_F11,
                KC_TRNS, KC_P4,   KC_P5,    KC_P6,    KC_PLUS, KC_F12,
       KC_TRNS, KC_TRNS, KC_P1,   KC_P2,    KC_P3,    KC_BSLS, KC_TRNS,
                         KC_P0,   KC_P0,    KC_DOT,  KC_EQL,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
...
[MDIA] = KEYMAP(
    ...
    // right hand
       ...
       KC_TRNS,  KC_BTN1, KC_MS_U, KC_BTN2, KC_TRNS, KC_TRNS, KC_TRNS,
                 KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_MPLY,
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
